...
<p align="center">
  <figure>
    <img src="https://tungnd1705.github.io/images/materials/PC3/control_from_image.png" alt="Trulli" style="width:60%">
    <figcaption>Figure 1. An example of optimal control from pixels. Everytime the robot moves, it receives an image of the environment taken from a camera sensor. Based purely on these data, the robot needs to find an optimal sequence of actions in order to perform a particular task, e.g., pick up an object on the table.</figcaption>
  </figure>
</p>
...
<p align="center">
  <figure>
    <img src="https://tungnd1705.github.io/images/materials/PC3/LCE.png" alt="Trulli" style="width:100%">
    <figcaption>Figure 2. LCE approach. First, learn the encoder and latent dynamics (left) and then perform control in the latent space (right).</figcaption>
  </figure>
</p>
...
<p align="center">
  <figure>
    <img src="https://tungnd1705.github.io/images/materials/PC3/predictive_coding.png" alt="Trulli" style="width:100%">
    <figcaption>Figure 3. Two high-level approaches to learn encoder E and decoder F.</figcaption>
  </figure>
</p>
...
<p align="center">
  <figure>
    <figcaption>Table 1. Percentage steps in goal state for the average model (all) and top 1 model.</figcaption>
    <img src="https://tungnd1705.github.io/images/materials/PC3/results.png" alt="Trulli" style="width:100%">
  </figure>
</p>
<p align="center">
  <figure>
    <img src="https://tungnd1705.github.io/images/materials/PC3/planar.gif" alt="Trulli" style="width:40%">
    <img src="https://tungnd1705.github.io/images/materials/PC3/pendulum.gif" alt="Trulli" style="width:20%">
    <img src="https://tungnd1705.github.io/images/materials/PC3/cartpole.gif" alt="Trulli" style="width:20%">
    <img src="https://tungnd1705.github.io/images/materials/PC3/3pole.gif" alt="Trulli" style="width:20%">
    <figcaption>Figure 4. Visualization of 4 domains during control. From left to right: Planar,  Inverted Pendulum, Cartpole, 3-Link Manipulator.</figcaption>
  </figure>
</p>
...
<p align="center">
  <figure>
    <img src="https://tungnd1705.github.io/images/materials/PC3/latent_map.png" alt="Trulli" style="width:100%">
    <figcaption>Figure 5. Left two: PCC, right two: PC3. Each color represents an angle, and different points of the same color represent different angular velocities.</figcaption>
  </figure>
</p>

<p align="center">
  <figure>
    <img src="https://tungnd1705.github.io/images/materials/PC3/latent_map_evolution.gif" alt="Trulli" style="width:70%">
    <figcaption>Figure 6. Visualization of latent maps during training. Left: Planar, right: Inverted Pendulum.</figcaption>
  </figure>
</p>
